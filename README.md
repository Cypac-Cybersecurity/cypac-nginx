...
> This release now includes the PHPMailer library (version 6.8.0) available at `/opt/phpmailer`. Additionally, `WeasyPrint` is installed and ready for use, making it easier to generate PDFs from your web content.
